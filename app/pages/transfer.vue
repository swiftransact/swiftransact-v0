<template>
  <div class="">
    ...
    <div class="card-bg rounded-[12px] mt-4 w-full p-4">
      <div
        class="bg-background2 flex justify-between items-center rounded-[8px] p-2 relative"
      >
        ...
        <div
          class="flex items-center gap-2 bg-background-input py-2 px-4 rounded-lg"
        >
          <img src="/images/coins/naira.png" class="object-contain w-5 h-5" />
          <span class="text-text-black text-base font-medium">NGN</span>
        </div>
        <div
          class="p-2 absolute top-[90%] left-1/2 -translate-x-1/2 border border-background1 rounded-[8px] bg-background2"
        >
          <Icon name="convert" :size="20" color="var(--color-black)" />
        </div>
      </div>
      <div
        class="bg-background2 flex justify-between items-center mt-2 rounded-[8px] p-2"
      >
        <div class="flex flex-col gap-3">
      ...
      <div
        class="bg-background2 text-text-black text-[11px] text-center mt-2 rounded-[8px] p-1"
      >
        1 USDC = 1,525NGN
      </div>
    </div>
    ...
    <!-- modals -->
    <LazyBottomSlider
      @update:model-value="activeModal = null"
      :modal="modal!"
      v-model="activeModal"
    />
  </div>
