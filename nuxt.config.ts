...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        {
          name: "description",
          content: "A modern financial transaction application",
        },
        {
          name: "viewport",
          content:
  ...
  pwa: {
    ...
    workbox: {
      ...
      globPatterns: ["**/*.{vue,css,otf,ts,html,js,svg,png,jpg,jpeg,mp4}"],
      swDest: "sw.js",
    ...
    manifest: {
      ...
      description: "A modern financial transaction application",
